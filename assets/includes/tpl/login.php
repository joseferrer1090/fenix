...
<html>
    <head>
        ...
        <title>Login | Fenix Premium</title>
      ...
      <div class="container">
        ...
        <div class="login-box space-donw-panel">
            ...
            <div class="login-box-body">
                <!--<p class="login-box-msg">Por favor Registrarse</p>-->
                <h2 class="text-center"> Inicio de Sesión </h2>
                <div id="status"></div>
                <hr>
                <form>
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="identificacion" name="uname" id="uname">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <input type="password" class="form-control" placeholder="contraseña" name="pwd" id="pass">
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="#"  class="btn btn-primary btn-block btn-flat" id="login">Ingresar</a>
                            <a href="/forgot-password"  class="btn btn-primary btn-block btn-flat">Olvidaste tu contraseña ?</a>
                            <a href="/forgot-pin"  class="btn btn-primary btn-block btn-flat">Olvidaste tu Pin ?</a>
