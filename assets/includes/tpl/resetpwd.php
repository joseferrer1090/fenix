    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box space-donw-panel">
            ...
            <div class="login-box-body">
                ...
                <form>
                    <p aling="justify"> 
                        Por favor, proporcione su nombre de usuario para recuperar su contraseña, le enviaremos un correo electrónico para la nueva contraseña.
                    </p>
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="usuario" name="uname" id="uname">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="#"  class="btn btn-success btn-block btn-flat" id="reset">Recuperar mi contraseña</a>
                            <a href="/login" class="btn btn-info btn-block btn-flat">Volver al inicio de Sesion</a>
                        </div><!-- /.col -->
                    </div>
                </form>
