...
if ($_SERVER["REQUEST_URI"] != "/install/save" && $_SERVER["REQUEST_URI"] != "/install" && $_SERVER["REQUEST_URI"] != "/update" && $_SERVER["REQUEST_URI"] != "/forgot-password/reset" && $_SERVER["REQUEST_URI"] != "/forgot-pin" &&  $_SERVER["REQUEST_URI"] != "/forgot-pin/reset" && $_SERVER["REQUEST_URI"] != "/forgot-password" && $_SERVER["REQUEST_URI"] != '/bonus/go' && $_SERVER["REQUEST_URI"] != '/login' && $_SERVER["REQUEST_URI"] != '/paypal-listen' && $_SERVER["REQUEST_URI"] != '/login/auth' && !is_login()) {
