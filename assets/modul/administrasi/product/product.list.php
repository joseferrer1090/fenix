...
//
if(count($data)<1){
echo "Usted no tiene ningún producto, Agrega un Producto";
exit;
}
$tbl .='<div class="tblwrap">'
        . '<div id="loading">'
        . '<p>Recuperación de datos del servidor.....</p>'
        . '</div>'
...
$tbl .=' <thead>
                                    <tr>
                                        ...
                                        <th data-hide="phone,tablet">Tarifa de devidencia de bonificación</th>
                                        <th data-hide="phone,tablet">Tasa de referencia de bonificación</th>
                                        <th data-hide="phone,tablet">pago máxima / día</th>
                                        <th data-hide="phone,tablet">Dias del plan </th>
