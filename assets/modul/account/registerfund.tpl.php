                        ...
                        <div class="panel-body">
                            <div id='suksesupdate' class="alert alert-success alert-block fade in" style='display:none;'>
                               <h4>
                                ...
                                <p>Yehaa.. Your fund has converted to bonus fund. Reload page in few seconds..</p>
                            </div>
                            <div id='gagalupdate' class="alert alert-danger alert-block fade in" style='display:none;'>
                                ...
                                <p id="msjerror">Fund conversion has been declined, make sure your PIN is correct, also make sure you have sufficient balance</p>
                            </div>
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="registerfund" method="POST" action="/account/register-balance/transfer">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button class="btn btn-primary" type="submit" id='submitpin'>Convert to Bonus Fund</button>
