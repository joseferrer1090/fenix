...
@$tipetrans = addslashes($_POST['tipetrans']);
@$namebit = addslashes($_POST['namebit']);
@$idbit = addslashes($_POST['idbit']);
@$numbit = addslashes($_POST['numbit']);
...
$cabeceras.= "Bcc: support@bvaults.com\n"; //La persona que envia el correo

$asunto = "Transacción para retiro de fondos "; //asunto aparecera en la bandeja del servidor de correo
$email_to = "noresponder@earthbit-coin.com," ."$email"; //cambiar por tu email
$contenido = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd'>
...
<p style:'color:#5F5F5F;'>Id user identified with the '$nombre' wants to withdraw funds from your account with a total of $'$monto' real usd wallet EARTHBIT </p>
<p style:'color:#5F5F5F;'>Message:'$mensaje' </p>
<p style:'color:#5F5F5F;'>Email: '$email'</p>
<p style:'color:#5F5F5F;'>Monto:$'$monto'</p>
<p style:'color:#5F5F5F;'>Type of trasaccion:'$tipetrans' </p>
<p style:'color:#5F5F5F;'>Bitoin wallet name: '$namebit'</p>
<p style:'color:#5F5F5F;'>Id wallet:$'$idbit'</p>
<p>Account number of bitcoin wallet:'$numbit'</p>
																					<br>
...
header('Location: http://secure.bvaults.com/account/withdraw?send=1'); 
}else{
