...
//
if(count($data)<1){
echo "No tienes ninguna cuenta bancaria, hazla por favor";
exit;
}
$tbl .='<div class="tblwrap">'
        . '<div id="loading">'
        . '<p>Buscando de datos del servidor .....</p>'
        . '</div>'
...
$tbl .='<thead>
           ...
           foreach($data as $key => $value){
                  $tbl .= "<tr>"
                            ...
                            . "<td><a href='/account/bank/edit/".$value["bank_id"]."'  class='btn btn-info' >EDITAR</a> <a href='javascript:void();' class='deletebank btn btn-danger' data-id='".$value["bank_id"]."'>ELIMINAR</a></td>"
                          . "</tr>";
           }
