<?php
        ...
        $tbl ='<div class="tblwrap"><div id="loading"><p>Recuperando datos del server.....</p></div><table id="downline-tbl" class="footable table-bordered table-striped table-condensed" data-sort="false">';
        $tbl .='<thead>
                <tr>
                    <thUsuarios</th>
           ...
           foreach($data as $key => $value){
               $tbl .= "<tr><td>".get_data($value,"uname")."</td><td>".date('F d, Y',strtotime(get_data($value,"register_date")))."</td><td>".get_data(get_parent($value, "int"),"uname")."</td><td>".get_sponsor($value, "uname")."</td></tr>";
           }
