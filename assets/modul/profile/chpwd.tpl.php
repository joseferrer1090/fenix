                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div id='gagalupdate' class="alert alert-danger alert-block fade in" style='display:none;'>
                                ...
                                <p>Cant update your Password, please make sure that you enter correct password & pin</p>
                            </div>
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="chpwd" method="get" action="">
                                    ...
                                    <div class="form-group ">
                                        <label for="token" class="control-label col-lg-2">Secret Pin</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="pin" name="pin" type="password" required />
                                        </div>
                                    </div>
